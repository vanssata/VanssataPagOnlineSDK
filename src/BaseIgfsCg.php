...
use VanssataPagOnlineSDK\Exceptions\ConnectionException;
use VanssataPagOnlineSDK\Exceptions\IgfsException;
use VanssataPagOnlineSDK\Exceptions\IgfsMissingParException;
use VanssataPagOnlineSDK\Exceptions\IOException;
use VanssataPagOnlineSDK\Traits\HttpClient;
...
abstract class BaseIgfsCg implements IgfsCgInterface
{
     ...
     * @param string $url
     *
     * @throws \VanssataPagOnlineSDK\Exceptions\IOException
     * @throws \VanssataPagOnlineSDK\Exceptions\IgfsException
     *
     * @return array
     */
