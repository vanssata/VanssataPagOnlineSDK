...
use VanssataPagOnlineSDK\XmlEntities\Traits\CastProperties;
use VanssataPagOnlineSDK\XmlEntities\Traits\EntityAttributes;
...
abstract class BaseXmlEntity implements XmlEntityInterface
{
     ...
     * @param string $xml
     *
     * @return null|\VanssataPagOnlineSDK\XmlEntities\XmlEntityInterface
     */
